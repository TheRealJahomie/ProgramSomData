...
and Tokenize  lexbuf =
  ...
  | 0 -> ( 
# 9 "../Intro/HelloLex/hello.fsl"
                                     LexBuffer<char>.LexemeString lexbuf 
# 28 "../Intro/HelloLex/hello.fs"
          )
  | 1 -> ( 
# 10 "../Intro/HelloLex/hello.fsl"
                                     failwith "Lexer error: illegal symbol" 
# 33 "../Intro/HelloLex/hello.fs"
          )
  | _ -> failwith "Tokenize"

# 13 "../Intro/HelloLex/hello.fsl"
  // ending
...
# 50 "../Intro/HelloLex/hello.fs"
# 3000000 "../Intro/HelloLex/hello.fs"
