...
and Tokenize  lexbuf =
  ...
  | 0 -> ( 
# 9 "../Intro/HelloLex/hello2.fsl"
                                      LexBuffer<char>.LexemeString lexbuf 
# 30 "../Intro/HelloLex/hello2.fs"
          )
  | 1 -> ( 
# 10 "../Intro/HelloLex/hello2.fsl"
                                     failwith "Lexer error: illegal symbol" 
# 35 "../Intro/HelloLex/hello2.fs"
          )
  | _ -> failwith "Tokenize"

# 13 "../Intro/HelloLex/hello2.fsl"
  // ending
...
# 52 "../Intro/HelloLex/hello2.fs"
# 3000000 "../Intro/HelloLex/hello2.fs"
